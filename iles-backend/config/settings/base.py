"""Base Django settings for ILES.

Following the layered settings pattern: this file holds defaults shared by
every environment. dev.py and prod.py override what they need.
"""
